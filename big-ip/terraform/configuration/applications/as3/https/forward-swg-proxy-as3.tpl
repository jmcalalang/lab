        ...
        "forwardSWGProxy": {
            ...
            "forwardSWGProxy": {
                ...
                "ssl-vip": {
                    ...
                    "profileTCP": "normal",
                    "profileHTTP": {
                        "use": "http-profile-forward-swg-proxy"
                    },
                    "profileAccess": {
                        "bigip": "/Common/calalang-swg-forward-proxy"
                    },
                    "policyPerRequestAccess": {
                        "bigip": "/Common/calalang-swg-forward-proxy-prp"
                    },                    
                    "serverTLS": "swgtlsServer",
                    "clientTLS": "swgtlsClient",
                    "allowVlans": [
                        "/Common/http-tunnel"
                    ]
                },
                ...
                "http-profile-forward-swg-proxy": {
                    "class": "HTTP_Profile",
                    "proxyType": "explicit",
                    "resolver": {
                ...
                "rejectirule": {
                    "class": "iRule",
                    "iRule": {
                        "base64": "d2hlbiBDTElFTlRfQUNDRVBURUQgewoJaWYgeyBbVENQOjpsb2NhbF9wb3J0XSAhPSA0NDMgfXsKCQlyZWplY3QKCX0KfQ=="
                    }
                },
                "swgtlsServer": {
                    "class": "TLS_Server",
